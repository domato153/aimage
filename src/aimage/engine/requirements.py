...
def derive_requirements(render_spec: RenderSpec, *, operation: str) -> RequirementSet:
    ...
    source_paths = tuple(obligation.semantic_path for obligation in render_spec.intent_obligations)
