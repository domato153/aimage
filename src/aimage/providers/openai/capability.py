...
def build_capability_descriptor(
    *,
    ...
    return ProviderCapabilityDescriptor(
        ...
        adapter_id="aimage.providers.openai",
        adapter_version="0.1.0-dev0",
        target_version_or_model=MODEL_SNAPSHOT,
        ...
        known_limits=(
            "declared documentation evidence until credentialed smoke reproduces generate/edit",
